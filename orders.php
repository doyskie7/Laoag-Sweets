...
<form method="POST" action="">        
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Online orders</h1>
  ...
  ?>
      <tr>
        ...
        <a href='javascript:delw(<?php print $row['id']; ?>)'>   
          <button type="button" class="btn btn-info btn-md" value = "<?php print $row['id']; ?>" name = "idtpro">
...
<?php
    ...
    if(isset($_GET['delw']))
          {  
            ...
            $fetch = "SELECT * from orders WHERE id ='".$_GET['delw']."'";
          ...
          $sql_query="DELETE FROM orders WHERE id =".$_GET['delw'];
          mysqli_query($con,$sql_query);       

          echo "<script>alert('Data has been moved to inventory!')</script>";

          echo "<META HTTP-EQUIV ='Refresh' Content ='0; URL =http://www.laoag-restau.local/orders.php'>";
...
function delw(id)
{
  ...
  {
    window.location.href='orders.php?delw='+id;
  }
}
</script>     
              </tbody>
